...
> 当前发布目标：`v0.4.x-preview`，围绕 Milestone 4 持续推进模板能力增强。
>
> 最新发布：`v0.3.7`（模板接入前置增强：门禁契约化、机器可读发布摘要、模板校验 JSON）
>
> 当前进行中：`v0.4.0-preview.1`（Milestone 4：模板模型增强、demo 模板扩展、模板门禁收敛）
