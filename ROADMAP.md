...
> 当前发布目标：`v0.3.x`，先完成通用能力正式发布，再进入模板接入增强。
>
> 最新发布：`v0.3.6`（通用能力正式版：回归摘要化、通用检查扩展、发布资产可复核）
>
> 当前进行中：`v0.3.7-preview.1`（模板接入前置：模板约束增强、文档与验收分层）
...
## Milestone 3：可验收交付（已完成，`v0.3.6` 正式发布）
